        ...
        <div className="p-8">
          ...
          <div className="space-y-6">
            ...
            {/* Description */}
                  ...
                  {/* Features section 
                  <div>
                    <h3 className="font-serialb text-lg mb-3 text-gray-700">Features</h3>
                    <ul className="list-none space-y-2">
                    <li className="font-serialt text-gray-600 flex items-center gap-2">
                      ✨ Large collection of cute stickers
                    </li>
                    <li className="font-serialt text-gray-600 flex items-center gap-2">
                      ✨ Intuitive drag-and-drop interface
                    </li>
                    <li class="font-serialt text-gray-600 flex items-center gap-2">
